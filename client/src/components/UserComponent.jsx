        ...
        <div className="USER text-center block_main rounded shadow">
            ...
            <input 
                ...
                {props.range_value==3 && (
                    ...
                    <br></br>
                    <b className="points_label">{props.attack_damage}</b><img src="../images/attack.png" alt="logo" width="10%" height="auto" />
                    <b className="points_label">{props.attack_defense}</b><img src="../images/defense.png" alt="logo" width="10%" height="auto" /><br></br>
